...
export default function DeleteACInCourse() {
    ...
    axios.post('http://localhost:5000/deleteAssignAcademicMember',{
    ...
    return (
        ...
        <Container style={{height:'250px'}} className="hdCompBig">
              ...
              Delete An Assignment Of An Academic Member To A Course  </h3>
        ...
        <input required='true' onChange = {e =>setStaffId(e.target.value)}></input></span>

           <span > <Button className='buttonAssign'onClick={handleSubmit}>
        Delete Assignment Of Member
      </Button></span></h5>
